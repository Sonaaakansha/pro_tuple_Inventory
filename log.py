...
class Login:
    def __init__(self, root):
        ...
        # ==========Images====================
        self.log_img = Image.open(file="C:\\Users\\Dell\\.vscode\\protuple_inventory\\4315251e5_Inventory-management-system-objectives.png")
    ...
    def login(self):
        con = sqlite3.connect(database=r'create_db.db')
        cur = con.cursor()
        try:
